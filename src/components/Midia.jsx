...
export default function Midia() {
  const [swiperInstanceDesktop, setSwiperInstanceDesktop] = useState(null)
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="hidden lg:grid grid-cols-12 gap-12 items-center">
          ...
          <motion.div 
            ...
            className="col-span-4 flex flex-col items-start relative z-20 bg-white py-8"
          >
            ...
            <p className="text-xl text-[#000f44] font-light mb-10 leading-relaxed relative z-10">
            ...
            <div className="flex gap-4 relative z-40">
              <button onClick={() => swiperInstanceDesktop?.slidePrev()} className="w-12 h-12 rounded-full bg-[#77df40] text-[#000f44] flex items-center justify-center hover:bg-[#0064f5] hover:text-white transition-all transform hover:scale-105 active:scale-95 shadow-md cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" /></svg>
              </button>
              <button onClick={() => swiperInstanceDesktop?.slideNext()} className="w-12 h-12 rounded-full bg-[#77df40] text-[#000f44] flex items-center justify-center hover:bg-[#0064f5] hover:text-white transition-all transform hover:scale-105 active:scale-95 shadow-md cursor-pointer">
          ...
          <div className="col-span-8 relative z-10">
            {/* O Swiper resolve o vazamento nativamente com overflow-visible */}
            <Swiper
        ...
        {/* ========================================================= */}
        {/* 📱 VERSÃO MOBILE (USANDO SWIPER NATIVO) */}
        {/* ========================================================= */}
        <div className="flex flex-col lg:hidden w-full gap-8">
          ...
          >
            ...
            <div className="flex gap-4">
              <button onClick={() => swiperInstanceMobile?.slidePrev()} className="w-12 h-12 rounded-full bg-[#77df40] text-[#000f44] flex items-center justify-center shadow-md active:scale-95 z-40 relative">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" /></svg>
              </button>
              <button onClick={() => swiperInstanceMobile?.slideNext()} className="w-12 h-12 rounded-full bg-[#77df40] text-[#000f44] flex items-center justify-center shadow-md active:scale-95 z-40 relative">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
              </button>
            </div>
          </motion.div>
          ...
          <div className="w-full relative">
            <Swiper
              ...
              spaceBetween={24}
              modules={[Navigation]}
              className="!overflow-visible py-8 -my-8"
            >
              {noticias.map((noticia, index) => (
