      ...
      <div className="container-custom relative z-20">
        ...
        >
          ...
          <div className="space-y-6 text-lg md:text-xl text-white/90 font-light leading-relaxed mb-12">
            ...
            <p>
              Com uma verdadeira imersão na teoria e na prática, você passa por <span className="font-bold text-[#77df40]">6 meses de treinamento em Java + IA, recebendo uma bolsa-auxílio de R$ 2.400,00,</span> podendo seguir para a 2ª etapa e fazer parte de uma das nossas squads. 
            </p>
            <p>
