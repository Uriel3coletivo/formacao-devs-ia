    ...
    <section className="bg-white py-24 md:py-32 relative overflow-hidden z-10">
      ...
      <div className="relative z-10">
        <div className="grid lg:grid-cols-12 gap-0 items-center">
          ...
          {/* LADO ESQUERDO: Textos (Com fundo branco SÓLIDO para esconder o card que rola) */}
            ...
            >
              {noticias.map((noticia, index) => (
                <motion.a
                  ...
                  // SOMBRA CORRIGIDA PARA AZUL MARINHO (#000f44)
                  className="snap-start shrink-0 w-[280px] md:w-[340px] xl:w-[400px] bg-white border border-gray-100 rounded-[32px] shadow-[0_10px_30px_rgba(0,15,68,0.15)] hover:shadow-[0_20px_40px_rgba(0,15,68,0.25)] transition-all duration-300 flex flex-col overflow-hidden group block"
                >
