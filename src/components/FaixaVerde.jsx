...
export default function FaixaVerde() {
  return (
    // MOBILE: pb-12 e min-h-[400px] (Reduz o espaço branco embaixo)
    // DESKTOP: lg:pb-32 e lg:min-h-[600px] (Intocado)
    <section className="bg-white py-32 pb-12 lg:pb-32 relative z-10 overflow-hidden flex flex-col justify-center items-center min-h-[400px] lg:min-h-[600px]">
