  ...
  return (
    <section className="bg-white py-20 lg:py-32 relative overflow-hidden z-10 w-full">
      ...
      <div className="container-custom relative z-10">
        ...
        {/* ========================================================= */}
        {/* 🖥️ VERSÃO DESKTOP (SOMBRA E VAZAMENTO RESOLVIDOS) */}
        {/* ========================================================= */}
        {/* gap-12 restaurado para dar o respiro correto entre colunas */}
        <div className="hidden lg:grid grid-cols-12 gap-12 items-center">
          ...
          <motion.div 
            ...
            className="col-span-4 flex flex-col items-start relative z-20 py-8"
          >
          ...
          <div className="col-span-8 relative z-10">
            {/* 
              A MÁGICA DEFINITIVA (CLIP-PATH):
              -100vh em cima e embaixo, -100vw na direita = vaza infinitamente.
              -24px na esquerda = corta o card, mas salva exatos 24px para a sombra redonda aparecer. 
            */}
            <div style={{ clipPath: 'inset(-100vh -100vw -100vh -24px)' }} className="py-8 -my-8">
              <Swiper
        ...
        {/* ========================================================= */}
        {/* 📱 VERSÃO MOBILE (BOTÕES AFASTADOS DO CARROSSEL) */}
        {/* ========================================================= */}
        <div className="flex flex-col lg:hidden w-full">
          ...
          >
            ...
            {/* mb-12 adicionado para afastar as setas do carrossel no celular */}
          ...
          <div className="w-full relative -mx-6 md:-mx-12">
            <Swiper
              onSwiper={setSwiperMobile}
              slidesPerView="auto"
              spaceBetween={24}
              slidesOffsetBefore={24} // Alinha o primeiro card com o texto no mobile
