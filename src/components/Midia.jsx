    ...
    <section className="bg-white py-24 md:py-32 relative overflow-hidden z-10">
      ...
      <div className="container-custom relative z-10">
        <div className="grid lg:grid-cols-12 gap-0 items-center">
          ...
          {/* LADO DIREITO: Carrossel com Fades Bilaterais */}
          <div className="col-span-12 lg:col-span-8 relative z-10">
            
            {/* Fade Branco na Esquerda (Para os cards sumirem suavemente ao entrarem no texto) */}
            ...
            {/* Fade Branco na Direita (Para os cards sumirem suavemente na borda da tela) */}
            ...
            >
              {noticias.map((noticia, index) => (
                <motion.a
                  ...
                  // Sombra atualizada para Azul Marinho (#000f44)
